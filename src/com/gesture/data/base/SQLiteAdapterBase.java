/**************************************************************************
 * SQLiteAdapterBase.java, WindowsGesture2 Android
 *
...
public abstract class SQLiteAdapterBase<T> {
	...
	public static final String TAG = "WindowsGesture2SQLiteAdapterBase";
	 ...
	 * Open Helper.
	 */
	protected WindowsGesture2SQLiteOpenHelper mBaseHelper;
	...
	protected SQLiteAdapterBase(final Context ctx) {
		this.ctx = ctx;
		this.mBaseHelper = new WindowsGesture2SQLiteOpenHelper(
				ctx,
				DB_NAME,
				null,
				WindowsGesture2Application.getVersionCode(ctx));
