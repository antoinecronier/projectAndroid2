/**************************************************************************
 * DataLoader.java, WindowsGesture2 Android
 *
...
public class DataLoader {
	...
	public DataLoader(final Context ctx) {
		...
		this.dataLoaders.add(
				ClientDataLoader.getInstance(this.ctx));
		this.dataLoaders.add(
				MachineDataLoader.getInstance(this.ctx));
		this.dataLoaders.add(
				CommandeDataLoader.getInstance(this.ctx));
		this.dataLoaders.add(
				ProduitDataLoader.getInstance(this.ctx));
		this.dataLoaders.add(
				LogTracaDataLoader.getInstance(this.ctx));
	}
