/**************************************************************************
 * WindowsGesture2ApplicationBase.java, WindowsGesture2 Android
 *
 ...
 * Harmony.
 * You should edit WindowsGesture2Application class instead of this
 * one or you will lose all your modifications.</i></b>
 *
 */
public abstract class WindowsGesture2ApplicationBase
	extends Application {

	/** TAG for debug purpose. */
	protected static final String TAG = "WindowsGesture2Application";
	/** Singleton. */
	private static volatile WindowsGesture2ApplicationBase singleton;
	/** Date format. */
	 ...
	 */
	private static void setSingleton(WindowsGesture2ApplicationBase application) {
		if (singleton == null) {
	 ...
	 */
	public static WindowsGesture2ApplicationBase getApplication() {
		return singleton;
	}
	...
	public static String getVersion(final Context ctx) {
		final SharedPreferences settings = ctx.getSharedPreferences(
				WindowsGesture2ApplicationBase.PREFS_PUBL,
				Context.MODE_WORLD_READABLE);

		return settings.getString(
				WindowsGesture2ApplicationBase.PREFS_VERS, "");
	}
