/**************************************************************************
 * DateTimeWidget.java, WindowsGesture2 Android
 *
 ...
 *
 **************************************************************************/
package com.gesture.harmony.widget;
...
import com.gesture.harmony.util.DateUtils.TimeFormatType;
		...
		switch (arg0.getId()) {
			...
			case R.id.time:
				...
				if (this.timeFormat.equals(TimeFormatType.AMPM)) {
					...
					format24H = WindowsGesture2Application.is24Hour();
				}
