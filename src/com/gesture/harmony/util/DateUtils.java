/**************************************************************************
 * DateUtils.java, WindowsGesture2 Android
 *
 ...
 *
 **************************************************************************/
package com.gesture.harmony.util;
...
public class DateUtils extends android.text.format.DateUtils {
	...
	public static String formatDateToString(DateTime date, boolean local) {
		java.text.DateFormat df = WindowsGesture2Application.getDateFormat();
	...
	public static String formatTimeToString(DateTime time) {
		String result = null;
		if (WindowsGesture2Application.is24Hour()) {
	...
	public static DateTime formatStringToDate(String date) {
		return formatStringToDateTime(WindowsGesture2Application
							.getDateFormat(), date);
	}
